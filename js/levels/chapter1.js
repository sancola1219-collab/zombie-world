...
export const CHAPTER1 = {
  ...
  name: '第一章：瞞天過海',
  next: 'chapter2',
  exitCode: '1946', // 大門備援密碼＝爆發時刻 19:46——線索拆散在總經理郵件（是「出事那一刻」）＋值班日誌（19:46）
  exitHint: '大門電子鎖斷電，只剩備援密碼盤——線索散在總經理郵件和值班日誌裡',
  ...
  documents: [
    ...
    {
      id: 'doc-email', title: '總經理郵件（列印稿）', x: 7.2, z: 4.2,
      text: '主旨：Re: 投資人參訪動線\n\n……參訪當日大門走正常門禁。另，斷電備援密碼本季已更新，僅限主管知悉，勿外流。密碼就設成廠裡每個人都不會忘記的那一刻——出事的那一刻，用 24 小時制的四位數。\n\n（出事的那一刻……幾點幾分？值班日誌上應該記著。）',
    },
    {
  ...
  triggers: [
    { id: 't-office', room: 'office', text: '設備辦公室。螢幕還亮著，停格在被清空的 KY-01 文件頁面。',
      monologue: '（有人正在清資料。停電、資料被刪、監視器斷訊——這不是事故，是一場早就準備好的行動。）' },
    { id: 't-meeting', room: 'meeting', text: '會議室。長桌上散落著今早那份量產進度簡報，每一頁都乾淨、明亮、整齊。',
      monologue: '（假產能叫包裝，假數據叫預估，未驗證的材料叫機密技術。只要詞換得夠漂亮，犯罪就能變成策略。）' },
    { id: 't-qa', room: 'qa', text: '品保實驗室的抽風櫃還在低鳴。防爆櫃裡，KY-01 樣品在暗處泛著微弱的藍光。',
      monologue: '（欣儀說得對。這東西碰到血會增殖……那它早就不只是「添加劑」了。）' },
    { id: 't-reactor', room: 'reactor', text: '廠房深處傳來金屬撞擊聲……和某種拖行的腳步聲。', sound: 'groan',
      monologue: '（他們不是在做量產。他們是拿整座工廠當培養皿——反應槽、清洗水、廢液，全都是。）' },
    { id: 't-eroom', room: 'eroom', text: 'E區電氣室——黑色的液體佈滿地板，在暗處泛著藍光。', sound: 'groan', alert: true,
      monologue: '（添加劑不該靠近電氣室。這不是外洩……是系統回流。整座廠的管線，早就被它走遍了。）' },
    { id: 't-waste', room: 'waste', text: '空氣裡有腐敗的甜味。牆角的屍袋……在動？', alert: true,
      monologue: '（KY-02 要在 21:00 前運走。他們知道會失控，所以想趕在爆發前把「證據」清乾淨。）' },
    { id: 't-freight', room: 'freight', text: '貨梯的指示燈停在 B1。地上有拖行的痕跡，一路延伸進電梯縫隙。',
      monologue: '（警衛的無線電說「不要下去」。他們把東西留在下面了。而我，正站在唯一的出口前。）' },
    { id: 't-eastcorr', room: 'eastcorr', text: '玻璃窗外，雨下得更大了。遠處有犬吠。', sound: 'dogbark',
      monologue: '（那些黑色廂型車不是來救援的。是來收尾的。我得趕在他們封死大門之前出去。）' },
    { id: 't-guard', room: 'guard', text: '警衛室。大門的電子鎖沒電了，只剩備援密碼盤還亮著。',
      monologue: '（總經理的信提過備援密碼，卻沒寫數字——只說是「那個時刻」。哪個時刻？值班日誌裡也許有答案。）' },
  ],
